...
def train_star_deep_eca_dice_v4():
    print(f"\n{'=' * 60}")
    print("[FGFD] Star-Deep + ECA + Dice Loss (freeze=0)")
    print("  Model: star-deep-eca (same structure)")
    print("  Loss: v8SegLoss + Dice in seg_loss")
    print("  Only change: single_mask_loss = BCE + 0.5*Dice")
    print("  No extra loss terms, no dynamic decay, no boundary penalty")
    print(f"{'=' * 60}\n")

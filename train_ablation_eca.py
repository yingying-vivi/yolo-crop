...
YAML = "/home/fumu/xyy/ultralytics-crop/ultralytics-crop/ultralytics/cfg/models/11/yolo11-eca-seg.yaml"
...
class ECATrainer(SegmentationTrainer):
...
def train_ablation_eca():
    ...
    trainer = ECATrainer(overrides=args)

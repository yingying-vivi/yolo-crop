...
def train_star_deep_eca_dice_mr2_v4():
    print(f"\n{'='*60}")
    print(f"[FGFD] Star-Deep + ECA + Dice + mask_ratio=2 (freeze=0)")
    print(f"  mask_ratio=2: mask resolution 320x320 (vs 160x160 before)")
    print(f"  Higher mask resolution = finer boundary precision")
    print(f"{'='*60}\n")
    ...
    args = dict(
        ...
        device=DEVICE,
        project=PROJECT,
        name="fgfd_star_deep_eca_dice_mr2_v4",
        exist_ok=True,
        workers=8,
        seed=42,
        freeze=0,
...
if __name__ == "__main__":
    train_star_deep_eca_dice_mr2_v4()
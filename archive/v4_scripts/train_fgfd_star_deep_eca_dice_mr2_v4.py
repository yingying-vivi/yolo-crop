...
def train_star_deep_eca_dice_mr2_v4():
    print(f"\n{'=' * 60}")
    print("[FGFD] Star-Deep + ECA + Dice + mask_ratio=2 (freeze=0)")
    print("  mask_ratio=2: mask resolution 320x320 (vs 160x160 before)")
    print("  Higher mask resolution = finer boundary precision")
    print(f"{'=' * 60}\n")

...
def train_star_deep_eca_field_dice_v4():
    print(f"\n{'=' * 60}")
    print("[FGFD] Star-Deep + ECA + FieldDice Loss (freeze=0)")
    print("  Model: star-deep-eca (same structure)")
    print("  Mask loss: BCE + Dice (same as DiceSegLoss)")
    print("  Bbox loss: CIoU*0.8 + BoundaryIoU*0.2 (fixed, no decay)")
    print("  Loss dims: 5 (same as standard, no extra terms)")
    print(f"{'=' * 60}\n")

...
def train_star_deep_eca_field_adaptive_v4():
    print(f"\n{'=' * 60}")
    print("[FGFD] Star-Deep + ECA + FieldAdaptive Loss (freeze=0)")
    print("  Mask loss: BCE(area-adaptive boundary weight) + Dice")
    print("  Bbox loss: standard CIoU (unchanged)")
    print("  Boundary pixel weight = 1 + boundary * (2/sqrt(area))")
    print("  Small parcels: boundary weight up to 6x")
    print("  Large parcels: boundary weight ~1x (almost no boost)")
    print("  Loss dims: 5 (standard, no extra dimensions)")
    print(f"{'=' * 60}\n")

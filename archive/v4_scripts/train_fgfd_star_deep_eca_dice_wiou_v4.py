...
class StarDeepECADiceWIoUTrainer(SegmentationTrainer):
...
def train_star_deep_eca_dice_wiou_v4():
    ...
    args = dict(
        ...
        device=DEVICE,
        project=PROJECT,
        name="fgfd_star_deep_eca_dice_wiou_v4",
        exist_ok=True,
        workers=8,
        seed=42,
        freeze=0,
    ...
    trainer = StarDeepECADiceWIoUTrainer(overrides=args)
    results = trainer.train()
    return results


if __name__ == "__main__":
    train_star_deep_eca_dice_wiou_v4()

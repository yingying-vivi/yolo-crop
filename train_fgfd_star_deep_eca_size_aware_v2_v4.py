...
def train_size_aware_mask_v4():
    print(f"\n{'='*60}")
    print(f"[FGFD] Star-Deep + ECA + Size-Aware Mask + WIoU bbox (v2 fixed)")
    ...
    args = dict(
        ...
        device=DEVICE,
        project=PROJECT,
        name="fgfd_star_deep_eca_size_aware_v2_v4",
        exist_ok=True,
        workers=8,
        seed=42,
        freeze=0,

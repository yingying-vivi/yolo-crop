...
def train_dice_size_aware_v4():
    print(f"\n{'=' * 60}")
    print("[FGFD] Star-Deep + ECA + Dice + Size-Aware Mask (CIoU bbox)")
    print("  Model: star-deep-eca")
    print("  Bbox loss: CIoU (standard, no WIoU)")
    print("  Mask loss: BCE/area*size_weight + Dice")
    print("  size_weight = sqrt(0.05/area), clamped [1.0, 4.0]")
    print("  Purpose: verify area-weighting contribution WITHOUT WIoU")
    print(f"{'=' * 60}\n")
